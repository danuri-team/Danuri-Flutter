...
import 'package:danuri_flutter/data/view_model/home_view_model.dart';
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () async{
                      await _viewModel.test().then((value) => log('screen value = $value'),);
                    },
                    child: Container(
                      width: 138.w,
                      height: 48.h,
              ...
              Row(
                ...
                children: [
                  SelectButton(
                    ...
                    text: '공간 사용하기',
                    onTap: () {
                      _viewModel.registerUsedSpace('spaceId');
                    },
                  ),
                  SizedBox(width: 70.w),
                  SelectButton(
                    ...
                    text: '물품 대여하기',
                    onTap: () {
                      _viewModel.rentalItem('usageId', 'itemId', 0);
                    },
                  ),
                ],
              )
